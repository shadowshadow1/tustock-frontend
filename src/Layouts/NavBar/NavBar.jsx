...
const charts = [
  ...
  const features = [
    { titel: "Charts", desc: "Overview of the crypto market with real-time prices and key data", iconFirst: <PaperFinance className={styles.paperfinance} />, iconArrow: <AiOutlineArrowRight className={styles.arrowright} />},
    { titel: "Risk Matrix", desc: "View top market movers and price preformence", iconFirst: <PaperFinance className={styles.paperfinance} />, iconArrow: <AiOutlineArrowRight className={styles.arrowright} /> }
  ];
  
  const orderBook = [
    { titel: "Portfolio", desc: "Take a look at our marketing portfolio", iconFirst: <FlagFinance />, iconArrow: <AiOutlineArrowRight className={styles.arrowright} /> },
    { titel: "Current", desc: "Take a look at the market currently", iconFirst: <PaperFinance className={styles.paperfinance} />, iconArrow: <AiOutlineArrowRight className={styles.arrowright} /> },
    { titel: "Past", desc: "Take a look at the market in the past", iconFirst: <TargetFinance />, iconArrow: <AiOutlineArrowRight className={styles.arrowright} /> }
  ];
